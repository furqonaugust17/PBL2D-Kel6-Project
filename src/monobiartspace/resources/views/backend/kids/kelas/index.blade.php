    ...
    <script type="text/javascript">
                    ...
                    @role('supervisor')
                        {
                            ...
                            "render": function(data, type, row) {
                                let uriEdit = "{{ route('kids.edit', ['kid' => ':id']) }}"
                                    .replace(
                                        ':id', data);
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    let uriDelete = "{{ route('kids.destroy', ['kid' => ':id']) }}".replace(':id', id);
                    $.ajaxSetup({
                        headers: {
...
<x-app-layout>
    ...
    <div class="row">
        @role('supervisor')
            <div class="col-4">
                <a href="{{ route('kids.create') }}" class="btn btn-sm btn-primary">Tambah Data Kelas</a>
            </div>
        @endrole
