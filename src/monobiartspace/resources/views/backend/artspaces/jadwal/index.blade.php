    ...
    <script type="text/javascript">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            let uriEdit =
                                "{{ route('artspace-jadwal.edit', ['jadwalArtSpace' => ':id']) }}"
                                .replace(
                                    ':id', data);
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    let uriDelete = "{{ route('artspace-jadwal.destroy', ['jadwalArtSpace' => ':id']) }}".replace(
                        ':id',
                        id);
                    $.ajaxSetup({
                        headers: {
...
<x-app-layout>
    ...
    <div class="row">
        <div class="col-4">
            <a href="{{ route('artspace-jadwal.create') }}" class="btn btn-sm btn-primary">Tambah Data Jadwal</a>
        </div>
        <div class="col-12 m-t35">
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-jadwal" class="display nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Sesi</th>
