                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ $errors->any() ? old('nama_lengkap') : $customer->nama_lengkap }}">
                                    @error('nama_lengkap')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select class="default-select form-control wide" name="jk">
                                        <option value="l" {{ $customer->jk == 'l' ? 'selected' : '' }}>Laki-Laki
                                        </option>
                                        <option value="p" {{ $customer->jk == 'p' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ $errors->any() ? old('alamat') : $customer->alamat }}">
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ $errors->any() ? old('username') : $customer->user->name }}">
                                    @error('username')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ $errors->any() ? old('email') : $customer->user->email }}">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
