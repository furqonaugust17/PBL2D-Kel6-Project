...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('landing-page/assets/image/favicon.png') }}" rel="icon">
            ...
            <div class="container">
                ...
                <div class="row gy-4 align-items-center features-item">
                    <div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out"
                        data-aos-delay="200">
                        <img src="{{ asset('landing-page/assets/image/class_doll.jpg') }}" class="img-fluid"
                            alt="">
                    </div>
        ...
        <section id="gallery" class="gallery section">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('landing-page/assets/image/class_education.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ asset('landing-page/assets/image/class_education.jpg') }}"
                                    alt="" class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('landing-page/assets/image/event_collaboration.jpg') }}"
                                class="glightbox" data-gallery="images-gallery">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('landing-page/assets/image/monobi_after_school2.jpg') }}"
                                class="glightbox" data-gallery="images-gallery">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('landing-page/assets/image/monobi_after_school.jpg') }}"
                                class="glightbox" data-gallery="images-gallery">
        ...
        <div class="container footer-top">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <span class="sitename">Monobi</span>
                    </a>
                    <div class="footer-contact pt-3">
                        <p>Jl Arwana no 6 Ulak Karang</p>
                        <p>Padang, Indonesia 25134</p>
                        <p class="mt-3"><strong>Phone:</strong> <span>+62 822-4456-8338</span></p>
                        <p><strong>Email:</strong> <span>monobi@gmail.com</span></p>
                    </div>
