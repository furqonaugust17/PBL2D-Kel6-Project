    ...
    <script type="text/javascript">
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    let uriDelete = "{{ route('kids-kategori.destroy', ['kidsKategori' => ':id']) }}".replace(':id',
                        id);
                    $.ajaxSetup({
                        headers: {
...
<x-app-layout>
    ...
    <div class="row">
        @role('supervisor')
            <div class="col-4">
                <a href="{{ route('kids-kategori.create') }}" class="btn btn-sm btn-primary">Tambah Data Kategori</a>
            </div>
        @endrole
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-kategori" class="display nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
