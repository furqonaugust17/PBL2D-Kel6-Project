...
class HargaClassKidUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'jumlah_pertemuan' => ['required', 'integer', 'min:1', Rule::unique('harga_class_kids')->ignore($this->kidsPrice)->where(function ($query) {
