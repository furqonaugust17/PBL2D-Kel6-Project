                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Nama Customer</td>
                                    <td>:</td>
                                    <td class="px-2">{{ $data->nama_orang_tua }}</td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td>:</td>
                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Jadwal</td>
                                    <td>:</td>
                                    <td class="px-2">{{ $data->jadwal->hari }}
                                        ({{ date('H:i', strtotime($data->jadwal->mulai)) }} -
                                        {{ date('H:i', strtotime($data->jadwal->akhir)) }})</td>
                                </tr>
                                <tr>
                                    <td>Kategori</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td>Judul Tema</td>
                                    <td>:</td>
                                    <td class="px-2">{{ $data->judul_tema }}</td>
                                </tr>
                                <tr class="align-top">
                                    <td>Tema</td>
                                    <td>:</td>
                        ...
                        <div class="col-12">
                            ...
                            <table>
                                <tr>
                                    <td>Nama Lengkap</td>
                                    <td>:</td>
                                    <td class="px-2">{{ $data->nama_lengkap }}</td>
                                </tr>
                                <tr>
                                    <td>Nama Panggilan</td>
                                    <td>:</td>
                                    <td class="px-2">{{ $data->nama_panggilan }}</td>
                                </tr>
                                <tr>
                                    <td>Tanggal Lahir</td>
                                    <td>:</td>
                                    <td class="px-2">{{ date('d F Y', strtotime($data->tgl_lahir)) }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
