            ...
            <div class="card">
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('kids-price.store') }}" method="POST">
                            @csrf
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="harga"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Harga Pertemuan" required value="{{ old('harga') }}">
                                    @error('harga')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="jumlah_pertemuan"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Jumlah Pertemuan" required value="{{ old('jumlah_pertemuan') }}">
