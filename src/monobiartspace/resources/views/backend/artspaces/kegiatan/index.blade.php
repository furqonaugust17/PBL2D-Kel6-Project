    ...
    <script type="text/javascript">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            let uriEdit =
                                "{{ route('kegiatan-artspace.edit', ['kegiatanArtSpace' => ':id']) }}"
                                .replace(
                                    ':id', data);
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    let uriDelete = "{{ route('kegiatan-artspace.destroy', ['kegiatanArtSpace' => ':id']) }}"
                        .replace(':id', id);
                    $.ajaxSetup({
                        headers: {
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-kegiatan" class="display nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
